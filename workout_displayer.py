...
class WorkoutDisplayer:
    ...
    def _find_exercise(self, body_part, exercise_type, excluded_names):
        return next(e for e in workout_database.workouts if e.body_part == body_part and e.type == exercise_type and e.name not in excluded_names)
    ...
    def swap_workout(self, workout_schedule):
        ...
        if day and to_swap is not None:
            ...
            new_exercise = self._find_exercise(swap_with_body_part, "", [ex['Name'] for ex in workout_schedule[day-1]['Exercises']])
