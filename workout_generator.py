    ...
    def get_workout_plan_for_day(self, day, workout_days, used_compound_exercises, body_part_counts):
        ...
        if workout_days == 1:
            while len(workout_plan) < 4:
                compound_exercise = self._get_and_remove_random_exercise(compound_exercises_copy, used_compound_exercises)
            ...
            while len(workout_plan) < 4:
                ...
                accessory_exercise = self._get_and_remove_random_exercise(possible_exercises)
